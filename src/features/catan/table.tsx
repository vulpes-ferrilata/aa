...
import { Action, ConstructionType, DevelopmentCard as DevelopmentCardModel, DevelopmentCardStatus, DevelopmentCardType, GameDetail, MoveRobber, Player, PlayerColor, PlayKnightCard, ResourceCard as ResourceCardModel, ResourceCardType, SendTradeOffer, ToggleResourceCards } from 'features/catan/types';
...
const Table: FunctionComponent<IProps> = (props: IProps) => {
    ...
    return (
        <div className={classNames("flex flex-col-reverse w-full h-full sm-h-and-aspect-4/3:flex-row sm-h-and-aspect-4/3:rounded-xl sm-h-and-aspect-4/3:shadow-inner-lg dark:shadow-white/10", {
        ...
        })}>
            {
                tab === Tab.ResourceCard?
                    <div className="flex-auto relative flex w-full p-2 overflow-y-hidden overflow-x-auto transition-all sm-h-and-aspect-4/3:w-auto sm-h-and-aspect-4/3:h-full" onClick={props.selectPlayer}>
                        {
                        ...
                        {props.player.resourceCards.map(resourceCard => (
                            <div key={resourceCard.id} className="flex-content min-w-1/5 h-full z-0 last:flex-none sm-h-and-aspect-4/3:min-w-4" onClick={() => props.selectResourceCard && props.selectResourceCard(resourceCard)}>
                ...
                :
                    <div className="flex-none flex w-full h-1/4 aspect-square p-2 overflow-y-hidden overflow-x-auto transition-all cursor-pointer sm-h-and-aspect-4/3:w-auto sm-h-and-aspect-4/3:h-full" onClick={() => setTab(Tab.ResourceCard)}>
...

            {
                tab === Tab.DevelopmentCard?
                    <div className="flex-auto flex w-full p-2 overflow-y-hidden overflow-x-auto transition-all sm-h-and-aspect-4/3:w-auto sm-h-and-aspect-4/3:h-full sm-h-and-aspect-4/3:min-w-4">
                ...
                :
                    <div className="flex-none flex w-full h-1/4 aspect-square p-2 overflow-y-hidden overflow-x-auto transition-all cursor-pointer sm-h-and-aspect-4/3:w-auto sm-h-and-aspect-4/3:h-full" onClick={() => setTab(Tab.DevelopmentCard)}>
                        <div className="flex w-max h-full mx-auto">
            ...
            {
                tab === Tab.UserInfo?
                    <div className="flex-auto flex w-full p-2 overflow-y-hidden overflow-x-auto transition-all sm-h-and-aspect-4/3:w-auto sm-h-and-aspect-4/3:h-full">
                ...
                :
                    <div className="flex-none flex flex-col w-full h-1/4 aspect-square p-2 overflow-y-hidden overflow-x-auto transition-all cursor-pointer
